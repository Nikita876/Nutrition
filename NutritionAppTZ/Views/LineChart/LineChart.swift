...
class LineChart: UIView {
    ...
    private func drawCurvedChart() {
        ...
        if let path = CurveAlgorithm.shared.createCurvedPath(dataPoints) {
            let lineLayer = CAShapeLayer()
            lineLayer.path = path.cgPath
            lineLayer.strokeColor = #colorLiteral(red: 0.5803921569, green: 0.9607843137, blue: 0.9607843137, alpha: 1)
    ...
    /**
     Create titles at the bottom for all entries shown in the chart
     */
    private func drawLables() {
        if let dataEntries = dataEntries,
            ...
            for i in 0..<dataEntries.count {
                ...
                textLayer.foregroundColor = #colorLiteral(red: 0.6509803922, green: 0.6745098039, blue: 0.7450980392, alpha: 1).cgColor
    ...
    private func drawHorizontalLines() {
        ...
        if let gridValues = gridValues {
            for value in gridValues {
                ...
                lineLayer.path = path.cgPath
                lineLayer.fillColor = UIColor.clear.cgColor
                //lineLayer.strokeColor = #colorLiteral(red: 0.1294117719, green: 0.2156862766, blue: 0.06666667014, alpha: 1).cgColor
